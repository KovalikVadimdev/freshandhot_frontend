    ...
    <div className="menu__header-inner container">
      <header className="menu__header">
        <h2 className="menu__description">
          Our <span className="menu__description--highlight">Regular</span> Menu
        </h2>
      </header>
      ...
      <div className="menu__body">
        ...
        <ul className="menu__list">
          {foodItems
            .filter((food) => food.menu.includes("regular"))
            .map((item) => (
...
export default RegularFoodView;
